...
$script:stateRoot = Join-Path $env:LOCALAPPDATA "ObsidianGlassDesktop\dashboard"
$script:dataRoot = Join-Path $script:stateRoot "data"
$script:logRoot = Join-Path $script:stateRoot "logs"
New-Item -ItemType Directory -Path $script:dataRoot, $script:logRoot -Force | Out-Null
...
$script:modeDeckBackdropPath = Join-Path $script:root "assets\mode-deck-reference.jpg"
...
$script:logPath = Join-Path $script:logRoot "dashboard.log"
...
$script:speechWorkerPath = Join-Path $script:root "speech\whisper_worker.py"
$script:speechRuntimeRoot = Join-Path $env:LOCALAPPDATA "ObsidianGlassDesktop\runtime\speech"
$script:speechPythonPath = Join-Path $script:speechRuntimeRoot "python.exe"
$script:speechCachePath = Join-Path $script:speechRuntimeRoot "models"
$script:speechCudaPath = Join-Path $script:speechRuntimeRoot "cuda\libs"
...
$script:mediaRuntimeRoot = Join-Path $script:stateRoot "media"
New-Item -ItemType Directory -Path $script:mediaRuntimeRoot -Force | Out-Null
$script:pinnedMediaStatePath = Join-Path $script:mediaRuntimeRoot "player-state.txt"
$script:pinnedMediaCommandPath = Join-Path $script:mediaRuntimeRoot "player-command.txt"
$script:pinnedMediaStartPath = Join-Path $script:mediaRuntimeRoot "start.ps1"
$script:mediaAvatarPath = Join-Path $script:root "assets\media\strawberry-player-avatar.png"
